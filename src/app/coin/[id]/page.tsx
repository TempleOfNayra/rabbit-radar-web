      ...
      <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-lg p-6 mb-6 border border-purple-700/50">
        ...
        <div className="bg-gray-900/50 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold">Base Velocity: {score?.baseVelocity !== null && score?.baseVelocity !== undefined ? Number(score.baseVelocity).toFixed(4) : 'N/A'} ranks/day</h3>
        ...
        <div className="bg-gray-900/50 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold">Consistency Score: {score?.consistencyScore !== null && score?.consistencyScore !== undefined ? Number(score.consistencyScore).toFixed(2) : 'N/A'}/10</h3>
        ...
        <div className="bg-gray-900/50 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold">Volume Score: {score?.volumeScore !== null && score?.volumeScore !== undefined ? Number(score.volumeScore).toFixed(2) : 'N/A'}/10</h3>
        ...
        <div className="bg-gray-900/50 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold">Persistence Score: {score?.persistenceScore !== null && score?.persistenceScore !== undefined ? Number(score.persistenceScore).toFixed(2) : 'N/A'}/10</h3>
        ...
        <div className="bg-gray-900/50 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold">Red Flags Penalty: {score?.redFlagsPenalty !== null && score?.redFlagsPenalty !== undefined ? Number(score.redFlagsPenalty).toFixed(2) : 'N/A'}</h3>
        ...
        <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 rounded-lg p-6 border border-blue-700/50">
          ...
          <div className="space-y-3 mb-4">
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
              ...
              <span className="font-bold text-purple-400">{score?.baseVelocity !== null && score?.baseVelocity !== undefined ? Number(score.baseVelocity).toFixed(4) : 'N/A'}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
              <span className="text-gray-300">× Consistency Score (0-10)</span>
              <span className="font-bold text-green-400">{score?.consistencyScore !== null && score?.consistencyScore !== undefined ? Number(score.consistencyScore).toFixed(2) : 'N/A'}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
              <span className="text-gray-300">× Volume Score (0-10)</span>
              <span className="font-bold text-blue-400">{score?.volumeScore !== null && score?.volumeScore !== undefined ? Number(score.volumeScore).toFixed(2) : 'N/A'}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
              <span className="text-gray-300">× Persistence Score (0-10)</span>
              <span className="font-bold text-yellow-400">{score?.persistenceScore !== null && score?.persistenceScore !== undefined ? Number(score.persistenceScore).toFixed(2) : 'N/A'}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
              <span className="text-gray-300">× Red Flags Penalty (0-1)</span>
              <span className={`font-bold ${redFlagsInterp.color}`}>{score?.redFlagsPenalty !== null && score?.redFlagsPenalty !== undefined ? Number(score.redFlagsPenalty).toFixed(2) : 'N/A'}</span>
            </div>
          </div>
